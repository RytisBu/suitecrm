...
class UsersViewDetail extends ViewDetail
{
    ...
    function preDisplay()
    {
        ...
        if ($current_user->isAdmin()) {
            $this->dv->defs['templateMeta']['form']['buttons'][] = array('customCode' =>"<input id='spectate_button'  name='Spectate'  value='Spectate mode' onclick=\" window.location='index.php?module=Administration&action=spectate&user_id={$this->bean->id}'\" type='submit' value='Spectate mode'>");
        }
